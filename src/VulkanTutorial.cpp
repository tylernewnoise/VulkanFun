...
private:
    ...
    void createRenderPass() {
        // Creating a renderpass attachment description. Specify depth and color buffers, samples and how their contents
        // should be handled throughout rendering operations.
    ...
    void createTextureImageNormal() {
        ...
        createImage(static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texHeight), 1, VK_SAMPLE_COUNT_1_BIT,
                    VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_TILING_OPTIMAL,
                    VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT,
                    VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, textureImageNormal, textureImageMemoryNormal);
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.proj = glm::perspective(InteractiveState::get_distance(),
